...
print(" Akashic Tome Fixer ");

// A lot of stuff here is borrowed from ATM 3

/* All the books go in all the places */

var ashStarter = <akashictome:tome>.withTag({
...
ashStarter.addTooltip(format.aqua("Contains all books/guides in the game."));
mods.jei.JEI.addDescription(ashStarter, "The Akashic tome is a book to end all books");

mods.jei.JEI.addItem(ashStarter);

recipes.addShapeless(ashStarter, [<minecraft:stick>]);

// Add it to the init inventory
mods.initialinventory.InvHandler.addStartingItem(ashStarter);
